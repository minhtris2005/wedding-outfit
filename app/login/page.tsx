...
export default function LoginPage() {
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      // LOGIC QUAN TRỌNG: Chuyển hướng sau khi login thành công
      ...
      <div className="w-full max-w-[440px] bg-white rounded-[2rem] shadow-2xl shadow-black/5 p-6 sm:p-10 border border-neutral-100">
        ...
        <div className="space-y-6">
          <div className="group">
            ...
            <div
              className={`relative flex items-center border-2 rounded-2xl transition-all duration-300 px-4
              ${errors.email ? "border-red-500 bg-red-50/30" : "border-neutral-100 bg-neutral-50 focus-within:border-black focus-within:bg-white"}`}
            >
              <Mail
          ...
          <div className="group">
            ...
            <div
              className={`relative flex items-center border-2 rounded-2xl transition-all duration-300 px-4
              ${errors.password ? "border-red-500 bg-red-50/30" : "border-neutral-100 bg-neutral-50 focus-within:border-black focus-within:bg-white"}`}
            >
              <Lock
